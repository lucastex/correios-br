...
O servico de calculo de frete é gratuito no site dos correios, porem nao existe garantia de disponibilidade do mesmo.
...
É necessario importar as seguintes classes
...
Tire a bunda desta cadeira, faça um fork do projeto, altere o que achar necessario e envio um pull request. Este plugin e da comunidade e e responsabilidade de todos fazer ele crescer.
