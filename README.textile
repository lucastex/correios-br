...
Em caso de um erro retornado pelo Correios, uma exception irá ser lancada com a mensagem de erro que o Correios retornar, por exemplo: "CEP de origem invalido", ou "Tipo de encomenda nao disponivel para este destino", etc.
